 ...
 */
public class KidneyDonorsListAdapter extends BaseAdapter{

    private Cursor cursor;
    private Context context;

    public KidneyDonorsListAdapter(Cursor cursor, Context context) {
        this.cursor = cursor;
    ...
    public Object getItem(int position) {
        ...
        return new KidneyDonors(donorName,age,bloodGroup,phoneNo,address,location);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView==null)
        {
            ...
            convertView=inflater.inflate(R.layout.kidney_donors_list_item,null);
        }
